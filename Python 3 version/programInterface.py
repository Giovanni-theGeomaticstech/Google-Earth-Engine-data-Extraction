...
import sys
import tkinter
from tkinter import * #changed to uppercase Sept10
import main_Program
...
button_2 = tkinter.Button(window,text="Click me for Extraction",command = extraction)
button_3 = tkinter.Button(window,text="Display Results",command = display_results)
button_3.config(fg = "white",bg = "black")
